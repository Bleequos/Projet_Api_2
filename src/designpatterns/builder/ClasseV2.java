...
public class ClasseV2 {
    ...
    private ClasseV2(ClasseBuilder cb) {
    ...
    public static class ClasseBuilder{
        ...
        public ClasseBuilder(int idClasse,String sigle,int annee) throws Exception {
        ...
        public ClasseV2 build() throws Exception{

            return new ClasseV2(this);
        }
